...
namespace Axm.Rodoh.Action
{
    ...
    public sealed class ActionProductionAssetMarker : MonoBehaviour
    {
        ...
        [SerializeField] private string approvalFormat = ApprovalFormat;
        ...
        public IReadOnlyList<string> Validate(string expectedRole = null)
        {
            ...
            if (approvalFormat != ApprovalFormat) errors.Add("Production asset approval format is unsupported.");
