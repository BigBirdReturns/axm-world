...
function fixture(): CanonicalStorySource {
  return parseCanonicalStory({
    ...
    identity: {
      id: "episode-4-chapter-1-story",
      title: "Episode 4 Chapter 1 Story",
      version: "0.8.0",
    },
...
describe("World Episode 4 Chapter 1 receiver law", () => {
  it("crosses the Episode 3 to Episode 4 seam in both directions", () => {
    ...
    if (forward.kind !== "panel") throw new Error("Expected Osyraa's Offer opening.");
    expect(forward.cursor).toEqual({
      storyId: "episode-4-chapter-1-story",
      episodeId: "E04",
      chapterId: "E04-C1",
      panelId: "E04-C1-P01",
    });
  ...
  it("reports Episode 4 Chapter 2 as the sole outside continuation", () => {
    const story = fixture();
  ...
  it("preserves the inherited P31 media boundary while Episode 4 remains data", () => {
    const story = fixture();
