...
function fixture(): CanonicalStorySource {
  return parseCanonicalStory({
    ...
    identity: {
      id: "episode-4-story",
      title: "Complete Episode 4 Story",
      version: "0.10.0",
    },
...
describe("World complete Episode 4 receiver law", () => {
  it("crosses the final Episode 4 chapter seam in both directions", () => {
    ...
    if (forward.kind !== "panel") throw new Error("Expected The Dead Man's Checksum opening.");
    expect(forward.cursor).toEqual({
      storyId: "episode-4-story",
      episodeId: "E04",
      chapterId: "E04-C3",
      panelId: "E04-C3-P41",
    });
  ...
  it("closes Episode 4 and reports Episode 5 as the sole outside continuation", () => {
    const story = fixture();
    ...
    expect(advanceCanonicalStory(story, terminal)).toEqual({
      ...
      cursor: terminal,
      continuationPanelId: "E05-C1-P01",
    });
  });

  it("preserves the inherited P31 media boundary under complete Episode 4 data", () => {
    const story = fixture();
