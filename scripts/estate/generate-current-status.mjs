...
const capabilities = {
  ...
  creatorRecoveryKitContractPinned: typeof lock.repositories?.arc?.requiredCommit === "string",
};
...
const status = {
  ...
  repositories: {
    ...
    arc: {
      ...
      requiredCommit: lock.repositories.arc.requiredCommit,
