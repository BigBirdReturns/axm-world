...
function fixture(): CanonicalStorySource {
  return parseCanonicalStory({
    ...
    identity: { id: "episode-5-story", title: "Episode 5 Chapter 2 Story", version: "0.12.0" },
    ...
    episodes: [{
      id: "E01", number: 1, title: "Episode One", complete: true, nextChapterId: null,
      chapters: [chapter("E01-C1", 1, "Episode One Chapter", null, "E02-C1-P01", [
        manifestedPanel("E01-C1-P01", "E01-C1", 1, null, "E02-C1-P01"),
      ])],
    }, {
      id: "E02", number: 2, title: "Episode Two", complete: true, nextChapterId: null,
      chapters: [chapter("E02-C1", 1, "Episode Two Chapter", "E01-C1-P01", "E03-C1-P01", [
        manifestedPanel("E02-C1-P01", "E02-C1", 1, "E01-C1-P01", "E03-C1-P01"),
      ])],
    }, {
      id: "E03", number: 3, title: "The Omega Thread", complete: true, nextChapterId: null,
      chapters: [
        chapter("E03-C1", 1, "Headquarters", "E02-C1-P01", "E03-C2-P31", [
          manifestedPanel("E03-C1-P01", "E03-C1", 1, "E02-C1-P01", "E03-C2-P31"),
        ]),
        chapter("E03-C2", 2, "Lockout", "E03-C1-P01", "E03-C3-P60", [
          sourceRequiredPanel("E03-C2-P31", "E03-C2", 1, "E03-C1-P01", "E03-C3-P60"),
        ]),
        chapter("E03-C3", 3, "Prime Incident", "E03-C2-P31", "E04-C1-P01", [
          manifestedPanel("E03-C3-P60", "E03-C3", 1, "E03-C2-P31", "E04-C1-P01"),
        ]),
      ],
    }, {
      id: "E04", number: 4, title: "Fractured Allegiances", complete: true, nextChapterId: null,
      chapters: [
        chapter("E04-C1", 1, "Osyraa's Offer", "E03-C3-P60", "E04-C2-P21", [
          manifestedPanel("E04-C1-P01", "E04-C1", 1, "E03-C3-P60", "E04-C1-P20"),
          manifestedPanel("E04-C1-P20", "E04-C1", 2, "E04-C1-P01", "E04-C2-P21"),
        ]),
        chapter("E04-C2", 2, "Georgiou's Pattern", "E04-C1-P20", "E04-C3-P41", [
          manifestedPanel("E04-C2-P21", "E04-C2", 1, "E04-C1-P20", "E04-C2-P40"),
          manifestedPanel("E04-C2-P40", "E04-C2", 2, "E04-C2-P21", "E04-C3-P41"),
        ]),
        chapter("E04-C3", 3, "The Dead Man's Checksum", "E04-C2-P40", "E05-C1-P01", [
          manifestedPanel("E04-C3-P41", "E04-C3", 1, "E04-C2-P40", "E04-C3-P60"),
          manifestedPanel("E04-C3-P60", "E04-C3", 2, "E04-C3-P41", "E05-C1-P01"),
        ]),
      ],
    }, {
      id: "E05", number: 5, title: "Nursery World", complete: false, nextChapterId: "E05-C3",
      chapters: [
        chapter("E05-C1", 1, "The Song", "E04-C3-P60", "E05-C2-P21", [
          manifestedPanel("E05-C1-P01", "E05-C1", 1, "E04-C3-P60", "E05-C1-P20"),
          manifestedPanel("E05-C1-P20", "E05-C1", 2, "E05-C1-P01", "E05-C2-P21"),
        ]),
        chapter("E05-C2", 2, "The Mother", "E05-C1-P20", "E05-C3-P41", [
          manifestedPanel("E05-C2-P21", "E05-C2", 1, "E05-C1-P20", "E05-C2-P40"),
          manifestedPanel("E05-C2-P40", "E05-C2", 2, "E05-C2-P21", "E05-C3-P41"),
        ]),
      ],
    }],
  });
...
describe("World Episode 5 Chapter 2 receiver law", () => {
  it("crosses the Episode 5 chapter seam in both directions", () => {
    ...
    if (forward.kind !== "panel") throw new Error("Expected The Mother opening.");
    expect(forward.cursor).toEqual({
      storyId: "episode-5-story", episodeId: "E05", chapterId: "E05-C2", panelId: "E05-C2-P21",
    });
    expect(forward.receipt).toMatchObject({
      fromPanelId: "E05-C1-P20", toPanelId: "E05-C2-P21", episodeId: "E05",
      chapterId: "E05-C2", canonical: true,
    });
    const reverse = retreatCanonicalStory(story, forward.cursor);
    expect(reverse.kind).toBe("panel");
    if (reverse.kind === "panel") {
      expect(reverse.cursor).toMatchObject({ episodeId: "E05", chapterId: "E05-C1", panelId: "E05-C1-P20" });
    }
  });

  it("keeps Episode 5 incomplete and reports Chapter 3 as the sole continuation", () => {
    const story = fixture();
    expect(canonicalStoryCoverage(story)).toEqual({
      episodes: 5, chapters: 10, panels: 15, plates: 0,
      resolvedTextPanels: 0, unresolvedTextPanels: 15,
      resolvedPlateMappings: 0, unresolvedPlateMappings: 0,
      choiceNodes: 0, productionReady: false,
      incompleteEpisodeIds: ["E05"], continuationPanelIds: ["E05-C3-P41"],
    });
    const terminal = canonicalStoryCursorForPanel(story, "E05-C2-P40");
    expect(advanceCanonicalStory(story, terminal)).toEqual({
      kind: "extent-complete", cursor: terminal, continuationPanelId: "E05-C3-P41",
    });
  });

  it("preserves the P31 refusal and receives The Song and The Mother without expression", () => {
    const story = fixture();
    const p31 = story.episodes[2]!.chapters[1]!.panels[0]!;
    expect(canonicalStoryAssetIsManifested(p31.asset)).toBe(false);
    expect(p31.asset).toMatchObject({ status: "source-required", id: "asset:E03-C2-P31", expectedBytes: 156208 });
    expect("sha256" in p31.asset).toBe(false);
    expect(story.episodes[4]).toMatchObject({ id: "E05", title: "Nursery World", complete: false, nextChapterId: "E05-C3" });
    expect(story.episodes[4]!.chapters.map((candidate) => candidate.title)).toEqual(["The Song", "The Mother"]);
    expect(story.episodes[4]!.chapters.flatMap((candidate) => candidate.panels).every(
